...
// Importez vos styles Tailwind et les autres composants nécessaires

const Product = () => {
    const { commercantId } = useParams();
    console.log(commercantId);
    const dummyData = require("../utils/commerçants.json"); // Remplacez le chemin par le bon chemin
