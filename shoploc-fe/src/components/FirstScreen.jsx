...
function FirstScreen() {
    ...
    return (
        <div className="grid md:grid-cols-12 grid-cols-3 md:gap-12 gap-4 my-12">
            <div className="md:col-span-3 col-span-3 bg-shopgray order-4 md:order-1 relative flex flex-col rounded">
                <NewsSlider />
            </div>
